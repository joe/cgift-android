...
/**
 * Created by afresina on 2020-01-22.
 * Copyright 2020 Foxhall Whythe. All rights reserved.
 */
public class RedeemListAdapter extends RecyclerView.Adapter<RedeemListAdapter.WalletItemViewHolder> {
    //
    public static final String TAG = RedeemListAdapter.class.getName();
     ...
     */
    @Override
    public RedeemListAdapter.WalletItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(RedeemListAdapter.WalletItemViewHolder holderView, int position) {
        if (getItemViewType(position) == VIEW_TYPE_WALLET) {
            Wallet wallet = mWallets.get(position);
            RedeemListAdapter.DecoratedWalletItemViewHolder decoratedHolderView = (RedeemListAdapter.DecoratedWalletItemViewHolder) holderView;
...
//            addWalletLabel.setText("+ " + mContext.getString(R.string.TokenList_addTitle));
     ...
     * @param alpha
     */
    private void setWalletItemColors(RedeemListAdapter.DecoratedWalletItemViewHolder viewHolder, int alpha) {
    ...
    public class DecoratedWalletItemViewHolder extends RedeemListAdapter.WalletItemViewHolder {
        ...
        private DecoratedWalletItemViewHolder(View view) {
            ...
            mParent = view.findViewById(R.id.redeem_card);
